...
const SET_FILES = {
  spoken: 'spoken/samples.json', knowledge: 'knowledge/samples.json', high_risk: 'high_risk/samples.json',
  term: 'term/samples.json', explain: 'explain/samples.json', faq: 'faq/samples.json',
};
