...
## 评测集公开集初建 + 审计持久化（2026-08-19，`08e95db`/`a710f88`）

- ✅ 评测集公开集 220 条（口语 50/知识 50/高危 30/术语 30/解释 30/FAQ 30），`impl/m0-baseline/eval-sets/`，runner + 契约测试 5 例
- ✅ 审计文件 JSONL 持久化适配器（append-only/跨重启重建/fail-closed），`impl/m5/src/audit/persist-file.js`，测试 5 例
