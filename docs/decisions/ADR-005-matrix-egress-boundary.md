...
| 项 | 处理 |
|---|---|
| 角色级 egress 控制（哪些角色可发起外传） | **已确认不做**（2026-09-24 产品口径）：不角色化，外传由 ADR-001 审批轴治理（任何已认证主体可发起，但须双人审批 + 目标域白名单）。若未来产品改判，另立 ADR 给指定角色授 egress，本 ADR 豁免条款（INV-P3）随之修订。闭合 p000047。 |
