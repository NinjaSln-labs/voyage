...
> **修订（2026-09-24）**：本文「覆盖全 actionClass（含 egress）」表述中，**egress 部分由 [ADR-005](./ADR-005-matrix-egress-boundary.md) 修订**——egress 类能力不纳入角色矩阵判定，由 ADR-001 审批轴独立治理（详见 ADR-005 / INV-P3）。read/write/authorize 覆盖不变。
